 ...
 */
export function encode_create_order_output(ask_amount: Amount, ask_token_id: string | undefined, give_amount: Amount, give_token_id: string | undefined, conclude_address: string, network: Network): Uint8Array;
/**
